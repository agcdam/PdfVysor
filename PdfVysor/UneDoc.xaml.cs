...
namespace PdfVysor
{
    public sealed partial class UneDoc : Page
    {
        ...
        private void SetZoomValue()
        {
            ...
            {
                case 1:
                    GridDocuments.ItemTemplate = (DataTemplate)Resources["PdfDocuments1"];
                    ZoomIn.IsEnabled = true;
                    ZoomOut.IsEnabled = false;
                    break;
                case 2:
                    GridDocuments.ItemTemplate = (DataTemplate)Resources["PdfDocuments2"];
                    ZoomIn.IsEnabled = true;
                    ZoomOut.IsEnabled = true;
                    break;
                case 3:
                    GridDocuments.ItemTemplate = (DataTemplate)Resources["PdfDocuments3"];
                    ZoomIn.IsEnabled = true;
                    ZoomOut.IsEnabled = true;
                    break;
                case 4:
                    GridDocuments.ItemTemplate = (DataTemplate)Resources["PdfDocuments4"];
                    ZoomIn.IsEnabled = false;
                    ZoomOut.IsEnabled = true;
                    break;
            }
